...
# 2. Politicalness Filter
print("\n2/2 Downloading politicalness filter..")
print("Model: mlburnham/Political_DEBATE_large_v1.0")

pol_model = AutoModelForSequenceClassification.from_pretrained("mlburnham/Political_DEBATE_large_v1.0")
pol_tokenizer = AutoTokenizer.from_pretrained("mlburnham/Political_DEBATE_large_v1.0")
