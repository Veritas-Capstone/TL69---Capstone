''' 
This script uses Model 4(volf) as the baseline and takes in as input an article, splits it into sentences, feeds each sentence to the model, and aggregates the predicted bias for each sentence.
Todo-> 
